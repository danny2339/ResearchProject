...
namespace ResearchProject.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(CoffeeShopProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var coffeeShopProjectContext = _context.Accounts.Include(a => a.Role);
            return View(await coffeeShopProjectContext.ToListAsync());
        }
